...
KartePrescription.create(karte_history_id: 1, medicine_id: 1,amount: 20, as_needed: 0, as_needed_coment: '', coment: '1日3回食後に服用')
KartePrescription.create(karte_history_id: 2, medicine_id: 1,amount: 40, as_needed: 1, as_needed_coment: 'お腹が痛くなったら飲んでください', coment: '1日3回食後に服用')
KartePrescription.create(karte_history_id: 2, medicine_id: 3,amount: 50, as_needed: 0, as_needed_coment: '', coment: '寝る前に服用')
KartePrescription.create(karte_history_id: 2, medicine_id: 4,amount: 1210, as_needed: 1, as_needed_coment: '頭痛がひどいときに飲んでください', coment: '1日3回食後に服用')
KartePrescription.create(karte_history_id: 5, medicine_id: 5,amount: 123, as_needed: 0, as_needed_coment: '', coment: '朝食後に服用')
KartePrescription.create(karte_history_id: 5, medicine_id: 6,amount: 40, as_needed: 1, as_needed_coment: 'かゆみがある場合に使用', coment: '')
KartePrescription.create(karte_history_id: 5, medicine_id: 1,amount: 30, as_needed: 0, as_needed_coment: '', coment: '毎食後に服用')
KartePrescription.create(karte_history_id: 8, medicine_id: 3,amount: 100, as_needed: 1, as_needed_coment: '痛みが強いときに服用', coment: '')
KartePrescription.create(karte_history_id: 9, medicine_id: 5,amount: 100, as_needed: 0, as_needed_coment: '', coment: '夜のみ服用')
KartePrescription.create(karte_history_id: 10, medicine_id: 10,amount: 119, as_needed: 1, as_needed_coment: '不安を感じたときに飲んでください', coment: '')
