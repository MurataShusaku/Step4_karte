...
PatientHistory.create(patient_id:1, name: :'久保建英', kana_name: :'クボタケフサ', insuranse_card_number:12221347,insured_persons_numer:89201731, public_expense_number:31931317, public_healthcare_number:66110862,coverage_type: :'被扶養者' ,address: :'茨城県つくば市', memo: nil, birthdate: "2001-6-4",sex_id:0,insuranse_rate: 3,insured_relationship_type: "本人")
PatientHistory.create(patient_id:1, name: :'久保建英.最新', kana_name: :'クボタケフササイシン', insuranse_card_number:nil,insured_persons_numer: nil, public_expense_number:nil, public_healthcare_number:nil,coverage_type: :'被保険者',address:nil, memo: nil,birthdate: "2001-1-1",sex_id:0,insuranse_rate: 3,insured_relationship_type: "本人")
PatientHistory.create(patient_id:2, name: :'伊藤純子', kana_name: :イトウジュンコ, insuranse_card_number:78787878,insured_persons_numer:21321003, public_expense_number:31311111, public_healthcare_number:31441991,coverage_type: :'被保険者',address: :'フランス',birthdate: "1993-3-9", memo:'イトウジュンコのメモ',sex_id:1,insuranse_rate: 1,insured_relationship_type: "家族")
PatientHistory.create(patient_id:3, name: :'冨安健洋', kana_name: :トミヤスタケヒロ, insuranse_card_number:12238133,insured_persons_numer:31321933, public_expense_number:31309019, public_healthcare_number:99040911,coverage_type: :'被扶養者',address: :'イギリス',birthdate: "1998-11-5", memo:'こんにちは冨安です',sex_id:0,insuranse_rate: 1,insured_relationship_type: "家族")
PatientHistory.create(patient_id:4, name: :'三苫薫', kana_name: :ミトマカオル, insuranse_card_number:90213133,insured_persons_numer:9311933, public_expense_number:24330019, public_healthcare_number:99033411,coverage_type:nil,address: :'イギリス',birthdate: "1997-5-20", memo:'こんにちは三苫です',sex_id:0,insuranse_rate: 3,insured_relationship_type: "家族")
...
TreatmentMaster.create(name: :'注射', score: 100,category: 5)
TreatmentMaster.create(name: :'手術', score: 100,category: 7)
TreatmentMaster.create(name: :'鼻整形', score: 2900,category: 0)
TreatmentMaster.create(name: :'髭脱毛', score: 720,category: 0)
TreatmentMaster.create(name: :'シミ取り', score: 1890,insuranse_cover: true,category: 0)
